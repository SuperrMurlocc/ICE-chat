...
Chat::User::_iceD_receivePrivateMessage(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    this->receivePrivateMessageAsync(::std::move(iceP_fromUser), ::std::move(iceP_message), inA->response(), inA->exception(), current);
    return false;
}
/// \endcond
...
Chat::User::_iceD_receiveMessage(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    auto inA = ::IceInternal::IncomingAsync::create(inS);
    this->receiveMessageAsync(::std::move(iceP_fromRoom), ::std::move(iceP_fromUser), ::std::move(iceP_message), inA->response(), inA->exception(), current);
    return false;
}
/// \endcond
...
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_Chat_User_ops, iceC_Chat_User_ops + 8, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
...
Chat::AMD_User_receivePrivateMessage::~AMD_User_receivePrivateMessage()
{
}

Chat::AMD_User_receiveMessage::~AMD_User_receiveMessage()
{
}

/// \cond INTERNAL
IceAsync::Chat::AMD_User_receivePrivateMessage::AMD_User_receivePrivateMessage(::IceInternal::Incoming& in) :
    ::IceInternal::IncomingAsync(in)
{
}

void
IceAsync::Chat::AMD_User_receivePrivateMessage::ice_response()
{
    writeEmptyParams();
    completed();
}
...
/// \cond INTERNAL
IceAsync::Chat::AMD_User_receiveMessage::AMD_User_receiveMessage(::IceInternal::Incoming& in) :
    ::IceInternal::IncomingAsync(in)
{
}

void
IceAsync::Chat::AMD_User_receiveMessage::ice_response()
{
    writeEmptyParams();
    completed();
}
...
Chat::User::_iceD_receivePrivateMessage(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    this->receivePrivateMessage_async(new IceAsync::Chat::AMD_User_receivePrivateMessage(inS), iceP_fromUser, iceP_message, current);
    return false;
}
/// \endcond
...
Chat::User::_iceD_receiveMessage(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->read(iceP_message);
    inS.endReadParams();
    this->receiveMessage_async(new IceAsync::Chat::AMD_User_receiveMessage(inS), iceP_fromRoom, iceP_fromUser, iceP_message, current);
    return false;
}
/// \endcond
...
Chat::User::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_Chat_User_all, iceC_Chat_User_all + 8, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
